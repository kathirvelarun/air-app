# Extension 05 — Agent Alert Intake API

> Historical baseline. See the [current specification](extension_07_alert_api_current.md) for the latest implementation.
...
→ separate incidents. See [integration specification](extension_06_slack_ui_integration.md)
